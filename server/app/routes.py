...
api.add_resource(SchoolChartsData, '/get_charts_data') # to get a dictionary with all the charts necessary for the charts page
api.add_resource(UserChartsData, '/get_charts_data') # to get a dictionary with all the charts necessary for the charts page
